...
const UpdateServiceBox = () => {
  return (
    <Container>
        <FormBox>
            <PageName> Home/Service </PageName>
            <PageTitle> Update Service Details </PageTitle>
            <StyledForm>
                <StyledRow className="mt-5">
                    ...
                    <Input className="mt-2" placeholder="Service Provider ID" width="100%" height="2.5rem" />
                    </Col>
                </StyledRow>
                ...
                <StyledRow className="mt-3">
                    <Col md={3}>
                        <P1 weight="600" size="19.1339px" lineHeight="27px"> Upload Service Images </P1>
...
export default UpdateServiceBox;
