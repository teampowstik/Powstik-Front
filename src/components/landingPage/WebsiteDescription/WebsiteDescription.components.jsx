...
import { Description, DescriptionImageContainer, DescriptionWrapper, Diseases, NutritionWork, Rating } from './WebsiteDescription.styles'
import Image from '../../../assets/organic-products-hero 1 (1).png';
import BookButton from '../../../util/ShopNowButton';
