        ...
        <DescriptionContainer >
            ...
            </PageInfo>
            {
                descriptionstatus === "description" ?
                    <PageInfo>
                        <H1 style={{ marginRight: 30, cursor: "pointer", borderBottom: "2px solid rgba(139, 195, 74, 0.65)", marginBottom: 10, paddingLeft: 10, paddingRight: 10 }} active onClick={() => setdescriptionstatus("description")}>Description</H1>
                        <P1 color='#616161' style={{ cursor: "pointer", paddingLeft: 10, paddingRight: 10 }} onClick={() => setdescriptionstatus("vender")}>Vender info</P1>
                    </PageInfo>
                    :
                    <PageInfo>
                        <P1 color='#616161' style={{ marginRight: 10, cursor: "pointer", paddingLeft: 10, paddingRight: 10 }} active onClick={() => setdescriptionstatus("description")}>Description</P1>
                        <H1 style={{ cursor: "pointer", borderBottom: "2px solid rgba(139, 195, 74, 0.65)", marginBottom: 10, paddingLeft: 10, paddingRight: 10 }} onClick={() => setdescriptionstatus("vender")}>Vender info</H1>
                    </PageInfo>
            ...
            <PageInfo>
                ...
                <P1 color='#000000' weight={500} style={{ cursor: "pointer" }} onClick={() => setcount(count > 1 ? count - 1 : 1)}>-</P1>
